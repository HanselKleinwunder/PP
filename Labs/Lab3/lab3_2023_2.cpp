...
// В комментариях указать значения кодов символов в 10-чной и 16-чной системе счисления

	{
		...
		TCHAR ch2 = __T('Ф');	// ch2 = 1060 'Ф', 0x0424 'Ф'       Ф  d4
		TCHAR ch3 = 'Ф';       // ch3 = 65492, 0xffd4 0xffd4 'ￔ'    Ф  d4
...
//Интерпретируте наблюдаемые результаты

	{
		...
		char* pc = &cAr[0]; // &cAr[0]	0x00dffb2c "ABCDÌÌÌÌÌÌÌÌHûß". 
							//Выводим мусор, т.к. компилятор выводит значения, пока не встретит завершающий 0.
							//char *. Указатель на значение массива под индексом 0.
